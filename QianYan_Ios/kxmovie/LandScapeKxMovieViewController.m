//
//  LandScapeKxMovieViewController.m
//  FFmpegTest
//
...
@interface LandScapeKxMovieViewController () <UITabBarDelegate> {
...
- (id)initWithContentPath:(NSString *)path
    ...
    if (self) {
        ...
        __weak LandScapeKxMovieViewController *weakSelf = self;
        
        KxMovieDecoder *decoder = [[KxMovieDecoder alloc] init];
        
        decoder.interruptCallback = ^BOOL(){
            
            __strong LandScapeKxMovieViewController *strongSelf = weakSelf;
...
- (void)loadVie {
    ...
    UIView *bgView = [[UIView alloc] initWithFrame:_bottomBar.bounds];
    bgView.backgroundColor = [UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:0.8];
    [_bottomBar insertSubview:bgView atIndex:0];
    ...
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(234, 5, 100, 50)];
...
#pragma mark - 视频位置
    if (_decoder.validVideo) {
        _glView = [[KxMovieGLView alloc] initWithFrame:CGRectMake(0, 0, 568, 320) decoder:_decoder];
    }
