...
- (NSAttributedString *)createAttributedEmotionStringWithRanges:(NSArray *)ranges
    ...
    for (int i = 0; i < _attributedData.count; i ++) {
        ...
        [attrString addAttribute:(id)kCTForegroundColorAttributeName value:(id)([UIColor colorWithRed:199/255.0 green:101/255.0 blue:4/255.0 alpha:1].CGColor) range:NSRangeFromString(str)];
